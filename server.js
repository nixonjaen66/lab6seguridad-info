...
const OKTA_CLIENT_ID = "0HRML5UJDg3fy9Icrx4PQEsBnkKY7xwA";
const OKTA_CLIENT_SECRET = "h8KznysLFpC2QHJHwTb_GDE1cnIesddtvURO-Yns_DQEYIJVG33QdeGOa8Bq7aWr";
const REDIRECT_URI = "http://localhost:3000/dashboard";
const PORT = process.env.PORT || "3000";
const SECRET = "DetT48pgoBB2BvxagFi9DzaUuE7JQAGSVKj76mYV07ZTin5awitSWEBjBSm-oi22"; // Dejar el secret así como está.
...
const config = {
  ...
  clientID: '0HRML5UJDg3fy9Icrx4PQEsBnkKY7xwA',
  issuerBaseURL: 'https://dev-7cpdiflxggx6wvyu.us.auth0.com'
};
